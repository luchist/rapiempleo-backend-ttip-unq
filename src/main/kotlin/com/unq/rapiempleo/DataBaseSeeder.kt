    ...
    fun seed() {
        ...
        val ofertas = listOf(
            ...
            Oferta("Contador Sr", "Tepago SA", "descriptions/ContadorPagoOffer.md".readClasspathFile(),
                Modalidad.Presencial, EstadoOferta.Abierto, 40000, 44000, "Temperley, Buenos Aires", favorito = false),
            Oferta("Desarrollador FrontEnd", "Electro Smart", "descriptions/FrontElectroOffer.md".readClasspathFile(),
                Modalidad.Remoto, EstadoOferta.Abierto, 48000, 54000, "Caballito, Buenos Aires", favorito = false),
            Oferta("Jefe de cocina", "Delicatus", "descriptions/JefeCocinaOffer.md".readClasspathFile(),
                Modalidad.Presencial, EstadoOferta.Abierto, 65000, 72000, "Recoleta, Buenos Aires", favorito = false),
            Oferta("Organizador de Eventos", "Sweet Retro", "descriptions/OrganizadorSweet.md".readClasspathFile(),
                Modalidad.Presencial, EstadoOferta.Abierto, 42000, 48000, "Villa Mercedes, San Luis", favorito = false),
            Oferta("Frontend Developer", "NovaTech", "descriptions/FrontNovatechOffer.md".readClasspathFile(),
                Modalidad.Presencial, EstadoOferta.Abierto, 51000, 57000, "Buenos Aires, Argentina", favorito = false),
            Oferta("Backend Engineer", "CloudSync", "descriptions/CloudSyncBackOffer.md".readClasspathFile(),
                Modalidad.Remoto, EstadoOferta.Abierto, 47000, 54000, "Ciudad de México, México", favorito = false),
            Oferta("UX Designer", "PixelLab", "descriptions/PixelLabUXOffer.md".readClasspathFile(),
                Modalidad.Hibrido, EstadoOferta.Abierto, 52000, 57000, "Buenos Aires, Argentina", favorito = false),
            Oferta("Analista en Marketing", "Onsu", "descriptions/OnsuAnalistaOffer.md".readClasspathFile(),
                Modalidad.Presencial, EstadoOferta.Abierto, 35000, 39000, "Paraná, Entre Ríos", favorito = false),
